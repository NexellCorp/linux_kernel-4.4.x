...
#define	ATTRIBUTE_MODE	0644
static struct device_attribute __guid__ =
			__ATTR(guid, ATTRIBUTE_MODE, sys_id_show, NULL);
static struct device_attribute __uuid__ =
			__ATTR(uuid, ATTRIBUTE_MODE, sys_id_show, NULL);
static struct device_attribute __name__ =
			__ATTR(name, ATTRIBUTE_MODE, sys_id_show, NULL);
