...
static int _set_phys_from_fd(struct nx_deinterlacer *me,
	...
	src0_y_stride = src_buf0->plane3.src_stride[0];
	src0_c_stride = src_buf0->plane3.src_stride[1];
	src1_y_stride = src_buf1->plane3.src_stride[0];
	src1_c_stride = src_buf1->plane3.src_stride[1];
