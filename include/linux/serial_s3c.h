...
#define S5P6818_UFCON_TXTRIG8	(1<<8)
#define S5P6818_UFCON_TXTRIG16	(1<<8)
#define S5P6818_UFCON_RXTRIG8	(0<<4)
...
#define S5P6818_UCON_DEFAULT	(S3C2410_UCON_TXILEVEL |	\
				 S3C2410_UCON_RXILEVEL |	\
				 S3C2410_UCON_TXIRQMODE |	\
				 S3C2410_UCON_RXIRQMODE |	\
				 S3C2410_UCON_RXFIFO_TOI |	\
				 ...
				 //S3C64XX_UCON_TXBURST_8 |	\
				 //S3C64XX_UCON_RXBURST_8|	\

#define S5P6818_UFCON_DEFAULT	(S3C2410_UFCON_FIFOMODE |	\
				 S5P6818_UFCON_TXTRIG16 |	\
				 S5P6818_UFCON_RXTRIG8)
