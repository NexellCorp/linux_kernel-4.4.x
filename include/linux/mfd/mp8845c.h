...
extern int mp8845c_set_bits(struct i2c_client *client, u8 reg,
	uint8_t bit_mask);
extern int mp8845c_clr_bits(struct i2c_client *client, u8 reg,
	uint8_t bit_mask);
extern int mp8845c_update(struct i2c_client *client, u8 reg, uint8_t val,
	uint8_t mask);
